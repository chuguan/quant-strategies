...
for dt in recent:
    ...
    for ri in [2,3]:
        if ri <= len(scored):
            if (scored[ri-1][1].get('n', 0) or 0) >= 2.5: w2_3[ri-2] += 1
        ta2_3[ri-2] += 1
...
print(f'#2: {w2_3[0]}/{ta2_3[0]} = {w2_3[0]*100/max(1,ta2_3[0]):.1f}%')
print(f'#3: {w2_3[1]}/{ta2_3[1]} = {w2_3[1]*100/max(1,ta2_3[1]):.1f}%')
